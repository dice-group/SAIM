...
public class LandingPage extends CustomComponent {
	public static final String videoFile1 = "screencast/noaudio.mp4";
	public static final String videoFile2 = "screencast/noaudio.ogg";
	@AutoGenerated
...
//        v.setSizeFull();
	...
	private Label getVideoLabel() {
		...
		l.setValue("<h1>Screencast</h1>" +
				"This is a Screencast capturing the main features of SAIM. Note that it is currently without audio.");
		return l;
	}
}
